...
SAVE_PATH = os.path.join(parent_directory, "download_pic", "area")

# 路径不存在时添加
if not os.path.exists(SAVE_PATH):
    os.makedirs(SAVE_PATH)

Pattern_AI_area_change_BP = Blueprint("Pattern_AI_area_change", __name__)


# 后续AI
def area_func(color, rf, mask):
    pass


@Pattern_AI_area_change_BP.route("/api/pic_ai/area_change", methods=["POST"], endpoint="/Pattern_AI_area_change")
def Pattern_AI_area_change():
